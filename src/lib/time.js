...
export function getEcoaTime(date) {
...
export function getEcoaTime2(dateTime) {
...
export function ecoaTimeToJsDate(time) {
    if (time == 0) {
...
// Type 10: 19:00 
export function dateToUserFriendly(date, type) {
